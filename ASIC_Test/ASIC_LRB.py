# -*- coding: utf-8 -*-
"""
Created on Fri Jun  5 10:55:11 2020
...
import Trees.ASICTree_LRB as ASICConfig
...
# ############################Single Adquisition Long##############################
    def on_btnStartSingleAdq(self):
        ...
        self.GenKwargs = self.ASICParams.GetGenParams()
        print(self.GenKwargs)
        ...
        # Sars = np.array(self.Sar_0, self.Sar_1, self.Sar_2, self.Sar_3)#no se si esta bien configurado el array
        # for ind, Sar in enumerate(Sars):
        # # convertir sars
        #     Sars_Data, Y_Data = AS.Conversion(Data=Sar,
        #                                       FS = self.GenKwargs["FS"])
        # # cridat plots ams row data (probar amb plt.plot())
        #     plt.figure('Sar'+str(ind))
        #     plt.plot(Sars_Data, Y_Data)
